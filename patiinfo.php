...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">Al hacer clic en generar examenes clinicos se le enviara al apartado en donde registrara los resultados del estudio clinico previo.</h4>
<br />
...
<tr valign="middle">
    ...
    <td  align="center"><a target="_blank" href="opdinvo.php?id=<?php echo $row["pet_id"]; ?>" name="ad">Generar Examenes Clinicos</a></td>
