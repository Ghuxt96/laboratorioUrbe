...
//Checking is user existing in the database or not
	...
	if($rows==1){
		...
		header("Location: patiinfo.php"); // Redirect user to index.php
	}
	else if ($rowss==1){
		$_SESSION['sadmun'] = $username;
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<center>
	<img id="mimg" src="images/log/avatar.png" class="img-responsive" />
	<br>
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>Ingrese los detalles de inicio de sesión proporcionados para el correcto acceso al portal.
<br>
	<br>suario: urbeadmin Pass: 1234abcd.. "con los 2 puntos"</div>
	</div>
