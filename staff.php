...
<form id="sreg" name="sreg" action="" method="post">
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "><input pattern="\d{11,11}"  maxlength="11" title="Número de móvil no válido número de caracteres debe ser 11" name="tel" required  type="tel" class="form-control" placeholder="Número de Contacto" style="border-radius:0px"></div><script type="text/javascript">
