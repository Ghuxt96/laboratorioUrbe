...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Los Pacientes registrados en este apartados están conectados directamente con el departamento de pacientes externos de la clinica y los médicos.</div>
</div>
</div>
...
<?php $count++; } ?>
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "> <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">C.I</span><input  pattern="\d{0,9}"  maxlength="10" title="Número de cedula no válido Utilice solo numeros no letras" name="ci" required  type="text" class="form-control" placeholder="Número de Cedula" style="border-radius:0px"></div><script type="text/javascript">
